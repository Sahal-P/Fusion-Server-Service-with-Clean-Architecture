...
import threading
import ast
from src.infrastructure.orm.db.server.repositories import ServerDataBaseRepository
...
def run_rabbitmq_consumer():
    ...
    def process_message(body):
        ...
        ServerDataBaseRepository().create_user(**deserialized_data)
    ...
    channel.basic_consume(
        queue="user-created", on_message_callback=process_single_message
    )
