...
class Server(models.Model):
    ...
    avatar = models.CharField(gettext_lazy('avatar'), max_length=100, blank=True, null=True)
    cover_photo = models.CharField(gettext_lazy('cover_photo'), max_length=100, blank=True, null=True)
    discription = models.TextField(gettext_lazy('discription'), db_index=True, blank=True, null=True)
