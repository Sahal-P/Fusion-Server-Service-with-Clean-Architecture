...
class UserDataBaseRepository:
    ...
    def create_user(self, email: str, phone: str, username: str, name: str, id: int, surname: str = None ) -> UserEntity:
        try:
            user = User.objects.create(email=email, user_id = id,
                                       phone=phone, username=username, 
                                       name=name, surname=surname  
                                    )
            print('llllllllllllllllllllllllllllllllll',user)
